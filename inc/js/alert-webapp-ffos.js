...
document.addEventListener("DOMContentLoaded", function() {
  ffos_bookmark = {
    content:"Do you want to install this site as an application on your system with Firefox/Firefox for Android/Firefox OS?",
    close:"Close",
    host:"http://dbproj-aroblu94.rhcloud.com"
  };
...
(function(name, context, definition) {
  ...
  Modal.prototype._init = function() {
    ...
    this.modalWindow.style.display = 'inline';
